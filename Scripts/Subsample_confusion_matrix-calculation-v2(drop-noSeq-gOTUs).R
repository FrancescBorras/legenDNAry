...
library(EDIutils)
  ...
  #              dnamat=dnamat,
  #              stem.otu=stem.otu),
  #         "Processed_data/stem-soil-Gsubsample-data-drop_noSeq_gOTUs-20250312.RDA")
  # 
  ...
  g <- readRDS("Processed_data/stem-soil-Gsubsample-data-drop_noSeq_gOTUs-20250312.RDA")
  ...
  saveRDS(list(conf_stats_obs=conf_stats_obs, 
          ...
          file=paste0("Processed_data/Conf_matrix_output-Gplots-drop_noSeq_gOTUs-20250312.RDA"))
